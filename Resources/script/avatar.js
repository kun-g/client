...
Avatar.prototype.addEffect = function(param){
    ...
    if( param.serverId != null ){
        if( this.EffectList[param.serverId] != null ){
            this.removeEffect(param.serverId);
        }
...
Avatar.prototype.removeEffect = function(sid){
    if( this.EffectList[sid] != null ){
        var data = this.EffectList[sid];
        data.node.removeFromParent();
        delete this.EffectList[sid];
    }
}
                ...
                if( effects != null )
                {
                    for(var k in effects)
                    {
                        ...
                        if( this.box.owner[eff.part] != null ){
                            if( part.node != null ){
                                //debug("AVATAR ("+eff.file+")->("+eff.part+")");
