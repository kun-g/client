(function() {
  var Bag, CONTAINER_TYPE_BAG, CONTAINER_TYPE_CARD_STACK, CONTAINER_TYPE_FURANCE, CardStack, PlayerBag, STACK_TYPE_MULTIPLE_STACK, STACK_TYPE_SINGLE_STACK, Serializer, registerConstructor, _ref,
  ...
  Bag = (function(_super) {
    ...
    Bag.prototype.validate = function() {
      var _this = this;
      return this.container.map(function(item, index) {
        if (item == null) {
          return null;
        }
        if (item.count <= 0) {
