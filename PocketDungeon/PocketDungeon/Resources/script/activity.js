...
function showDailyPrize(day){
    ...
    theLayer.NODE = cc.BuilderReader.load("ui-loginprize.ccbi", theLayer.owner);
    var winSize = cc.Director.getInstance().getWinSize();
    theLayer.NODE.setPosition(cc.p(winSize.width/2, winSize.height/2));
    ...
    theLayer.NODE.setScale(0);
    theLayer.NODE.runAction(actionPopIn());

//    theLayer.node.animationManager.runAnimationsForSequenceIdTweenDuration(0, 0.5);
    ...
    if( dailyQuest.step < 4 ){
        ...
        if( questData != null ){
            ...
            if( theQuest.State == QUESTSTATUS_COMPLETE ){
                layer.owner.btnGet.setNormalSpriteFrame(sfc.getSpriteFrame("dailymission-btn-lqjl1.png"));
                layer.owner.btnGet.setSelectedSpriteFrame(sfc.getSpriteFrame("dailymission-btn-lqjl2.png"));
                layer.owner.btnGet.setDisabledSpriteFrame(sfc.getSpriteFrame("dailymission-btn-lqjl2.png"));
                theDQInvokeAction = DQINVOKE_GETPRIZE;
            }
            else{
                layer.owner.btnGet.setNormalSpriteFrame(sfc.getSpriteFrame("dailymission-btn-ksrw1.png"));
                layer.owner.btnGet.setSelectedSpriteFrame(sfc.getSpriteFrame("dailymission-btn-ksrw2.png"));
                layer.owner.btnGet.setDisabledSpriteFrame(sfc.getSpriteFrame("dailymission-btn-ksrw2.png"));
...
function popDailyQuest(){
    cacheSprite("dailymission-btn-ksrw1.png");
    cacheSprite("dailymission-btn-ksrw2.png");
    cacheSprite("dailymission-btn-lqjl1.png");
    cacheSprite("dailymission-btn-lqjl2.png");
    ...
    layer.node = cc.BuilderReader.load("ui-dailymission.ccbi", layer.owner);
