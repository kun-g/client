...
//not for subclass
class JSCCBAnimCallbackWrapper: public CCObject {
public:
    JSCCBAnimCallbackWrapper() {}
    ~JSCCBAnimCallbackWrapper() {}
    
    void setJSCallbackThisFromNative(CCObject *pObj);
    void setJSCallbackFunctionName(const char *pFuncName);
