...
extern JSClass  *jsb_CCRectClip_class;
extern JSObject *jsb_CCRectClip_prototype;

JSBool js_cocos2dx_extension_CCRectClip_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_extension_CCRectClip_finalize(JSContext *cx, JSObject *obj);
