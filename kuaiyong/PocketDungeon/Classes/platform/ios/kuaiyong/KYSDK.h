...
enum{
    ...
    USER_CLICK_CHINAMOBLE = 7  //用户点击移动支付
}typedef BEHAVIOR;
...
/**
 ...
 userId支付的账户id
 **/
-(void)showPayWith:(NSString *)dealseq fee:(NSString *)fee game:(NSString *)game gamesvr:(NSString *)gamesvr subject:(NSString *)subject md5Key:(NSString *)md5Key appScheme:(NSString *)urlScheme userId:(NSString*)userId;
